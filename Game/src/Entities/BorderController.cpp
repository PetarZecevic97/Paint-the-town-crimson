...
namespace Game
{
    bool BorderController::Init(Engine::EntityManager* entityManager_, int window_width, int window_height, Engine::Texture* texture)
    {
        ...
        border->AddComponent<Engine::TransformComponent>(-static_cast<float>(window_width * 0.8 / 2) + 50.f, 0.f, 1.f, static_cast<float>(window_height));
        ...
        border->AddComponent<Engine::TransformComponent>(static_cast<float>(window_width / 2)-50.f, 0.f, 1.f, static_cast<float>(window_height));
        border->AddComponent<Engine::CollisionComponent>(1.f, static_cast<float>(window_height));
        border->AddComponent<Engine::SpriteComponent>().m_Image = texture;
        ...
        border->AddComponent<Engine::TransformComponent>(0.f, static_cast<float>(window_height / 2)-50.f, static_cast<float>(window_width), 1.f);
    ...
    void BorderController::Update(Engine::EntityManager* entityManager_, int window_width, int window_height)
    {
      ...
      leftTransform->m_Position.x = -static_cast<float>(window_width * 0.8 / 2) + 50.f;
      ...
      rightTransform->m_Position.x = static_cast<float>(window_width / 2) - 50.f;
      ...
      topTransform->m_Position.y = -static_cast<float>(window_height / 2) + 50.f;
      ...
      bottomTransform->m_Position.y = static_cast<float>(window_height / 2) - 50.f;
